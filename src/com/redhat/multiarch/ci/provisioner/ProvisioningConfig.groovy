...
class ProvisioningConfig {
  ...
  ProvisioningConfig(params, env) {
    ...
    println env.JENKINS_MASTER_URL
    this.JENKINS_MASTER_URL = new String(env.JENKINS_MASTER_URL) ?: this.JENKINS_MASTER_URL
    this.JSWARM_EXTRA_ARGS = new String(env.JSWARM_EXTRA_ARGS) ?: this.JSWARM_EXTRA_ARGS
  }
}
