...
class provisioningConfig {
    ...
    def create(params) {
        ...
        config.JENKINS_MASTER_URL = params.JENKINS_MASTER_URL ?: config.JENKINS_MASTER_URL
        config.JSWARM_EXTRA_ARGS = params.JSWARM_EXTRA_ARGS ?: config.JSWARM_EXTRA_ARGS
        return config
    }
}
